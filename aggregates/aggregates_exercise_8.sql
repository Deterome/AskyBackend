...
insert into bookings (facid, memid, starttime, slots) values(1, 3, '2012-10-14 09:00:00', 600);
insert into bookings (facid, memid, starttime, slots) values(1, 2, '2013-10-21 09:00:00', 600);

select * from bookings;

select bks.facid, sum(slots) as "Total Slots"
	from bookings bks
	group by facid
