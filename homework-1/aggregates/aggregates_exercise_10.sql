...
insert into facilities (name, membercost, guestcost, initialoutlay, monthlymaintenance) values('Tennis Court 1', 1000, 2500, 10000, 200);
...
select name, revenue
	from (select facs.name, sum(bks.slots * case
